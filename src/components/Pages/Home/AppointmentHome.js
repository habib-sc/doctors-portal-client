                ...
                <div class="flex justify-between items-center">
                    ...
                    <div className='flex-1'>
                        <div className='w-full text-white py-20 lg:py-0'>
                            ...
                            <p class="py-6 w-full">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
